...
import { setUpdate } from "../../redux/actions/update";
import { btnOrderOutClick } from "../../redux/actions/orderOut";
//import axios from 'axios';
// import PropTypes from 'prop-types';
import Loader from "../../components/layout/Loader";
import OrderOutDialog from "../../components/orders/parts/OrderOutDialog";
import { getNameById, getOrderSum, getOrderPayments } from "./ordersFunctions";
//import './orders.scss';
import { FilterControl } from "../../components/orders/parts/filtrerControl";
import { TdWithOverlay } from "../../components/orders/parts/TdWithOverlay";
import SearchControl from "../../components/orders/parts/searchControl";
import { TableHeader } from "../../components/orders/parts/TableHeader";
import { TdWithOrderButtons } from "../../components/orders/parts/orderButtons";
import { TdWithClientInfo } from "../../components/orders/parts/ClientInfo";
                            ...
                            {this.props.orders.map((order, index) => (
                                <tr key={index}>
                                    ...
                                    <TdWithOverlay
                                        ...
                                        overlay={order.mnts}
                                        value={getNameById(
                                            this.props.catalogs.item_types,
                                    ...
                                    <TdWithOverlay
                                        ...
                                        overlay={order.mnts}
                                        value={getNameById(
                                            this.props.catalogs.manufacturers,
                                    ...
                                    <td>
                                        {order.date_out
                                            ? formatDate(new Date(order.date_out), this.locale)
                                            : ""}
                                    </td>
