...
import { getOrder, saveOrder, changeOrderDate } from '../../actions/order';
import { btnClientEditClick } from '../../actions/orders';
  ...
  render() {
    return (
      <>
        <Card>
          <Card.Header>
            <ClientInfoButton client={this.props.client} onClick={this.btnClientEditClick} />
          </Card.Header>
        </Card>
        <OrderOutDialog />
        <OrderDates
